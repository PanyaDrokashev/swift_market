...
- В доменных и data-контрактах нет `UIKit`, что соответствует требованиям задания.
- Такой каркас удобно расширять до реальной реализации UI без переписывания контрактов.
